...
task ="flores" #"xnli" #"belebele"

path = f"flores-all_langs2-saes/{alpha}/{model}"
            ...
            for j in json_files:
                if s in j:
                    ...
                    with open(j, "r", encoding="utf-8") as f:
                        ...
                        bleu += results["mod"]["avg_bleu_success"]

                        comet += results["mod"]["avg_comet_success"]

                        if base_flag:
                            base_acc += results["base"]["langid_acc"] * 100
                            base_bleu += results["base"]["avg_bleu_success"]
                            base_comet += results["base"]["avg_comet_success"]
                            base_cnt += 1
